...
func (s *EventSuite) TestFullEventMarshal(c *C) {
	...
	uri, _ := url.Parse("http://andrewzeneski.com/some/attachment.ics")
	event.Attachment = values.NewUrl(*uri)
	event.Attendees = []*values.AttendeeContact{
		values.NewAttendeeContact("Jon Azoff", "jon@andrewzeneski.com"),
		values.NewAttendeeContact("Matthew Davie", "matthew@andrewzeneski.com"),
	}
	event.Categories = values.NewCSV("vinyasa", "level 1")
	event.Comments = values.NewComments("Great class, 5 stars!", "I love this class!")
	event.ContactInfo = values.NewCSV("Send us an email!", "<jon@andrewzeneski.com>")
	...
	event.Organizer = values.NewOrganizerContact("Jon Azoff", "jon@andrewzeneski.com")
	event.Priority = 1
	...
	uri, _ = url.Parse("matthew@andrewzeneski.com")
	...
	uri, _ = url.Parse("http://student.andrewzeneski.com/san-francisco/jonathan-azoff/vinyasa-1")
	...
	tmpl := "BEGIN:VEVENT\r\nUID:1:2:3\r\nDTSTAMP:%sZ\r\nDTSTART:%sZ\r\nDTEND:%sZ\r\nCREATED:%sZ\r\n" +
		...
		"ORGANIZER;CN=\"Jon Azoff\":MAILTO:jon@andrewzeneski.com\r\nPRIORITY:1\r\nSEQUENCE:1\r\nSTATUS:TENTATIVE\r\n" +
		"SUMMARY:Jon's Super-Sweaty Vinyasa 1\r\nTRANSP:OPAQUE\r\n" +
		"URL;VALUE=URI:http://student.andrewzeneski.com/san-francisco/jonathan-azoff/vinyasa-1\r\n" +
		"RECURRENCE-ID:%sZ\r\nRRULE:FREQ=WEEKLY\r\nATTACH;VALUE=URI:http://andrewzeneski.com/some/attachment.ics\r\n" +
		"ATTENDEE;CN=\"Jon Azoff\":MAILTO:jon@andrewzeneski.com\r\nATTENDEE;CN=\"Matthew Davie\":MAILTO:matthew@andrewzeneski.com\r\n" +
		"CATEGORIES:vinyasa,level 1\r\nCOMMENT:Great class, 5 stars!\r\nCOMMENT:I love this class!\r\n" +
		"CONTACT:Send us an email!,<jon@andrewzeneski.com>\r\nEXDATE:%s,%s\r\nRDATE:%s,%s\r\n" +
		"RELATED-TO;VALUE=URI:matthew@andrewzeneski.com\r\nRESOURCES:yoga mat,towel\r\nEND:VEVENT"
	sdate := now.Format(values.DateTimeFormatString)
	edate := end.Format(values.DateTimeFormatString)
